...
class MCTSAgent(Agent):
    def __init__(self, faction: Faction, mcts_type: str, reward_function: str, expand_count:int, rollout_no: int, time_limit: float, action_count_limit: int, best_action_policy: str):
        ...
        LOGGER.info("MCTSAgent:__init__: type {}, reward_function {}, expand_count {}, rollout_no {}, time_limit {}, action_count_limit {}, best action policy {}"
                    .format(mcts_type, reward_function, expand_count, rollout_no, time_limit, action_count_limit, best_action_policy))
    ...
    def choose_action(self, state: list, actions: list[Action]) -> Action:
        match self.mcts_type:
            ...
            case _:
                mcts = MCTS(state, actions, self.reward_function, self.expand_count, self.rollout_no, self.time_limit, self.action_count_limit, self.best_action_policy)
